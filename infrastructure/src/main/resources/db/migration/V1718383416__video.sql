...
CREATE TABLE videos (
    ...
    CONSTRAINT fk_v_video_id FOREIGN KEY (video_id) REFERENCES video_medias (id) ON DELETE CASCADE,
    CONSTRAINT fk_v_trailer_id FOREIGN KEY (trailer_id) REFERENCES video_medias (id) ON DELETE CASCADE,
    CONSTRAINT fk_v_banner_id FOREIGN KEY (banner_id) REFERENCES image_medias (id) ON DELETE CASCADE,
    CONSTRAINT fk_v_thumb_id FOREIGN KEY (thumbnail_id) REFERENCES image_medias (id) ON DELETE CASCADE,
    CONSTRAINT fk_v_thumb_half_id FOREIGN KEY (thumbnail_half_id) REFERENCES image_medias (id) ON DELETE CASCADE
);
