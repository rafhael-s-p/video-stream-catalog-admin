...
import com.studies.catalog.admin.infrastructure.configuration.properties.google.GoogleCloudProperties;
...
public class GoogleCloudConfig {
    ...
    public Credentials credentials(final GoogleCloudProperties props) throws IOException {
        final var credentials = props.getCredentials()
                .replaceAll("\\s", "");
        final var jsonBin = Base64.getDecoder()
                .decode(Objects.requireNonNull(credentials));
