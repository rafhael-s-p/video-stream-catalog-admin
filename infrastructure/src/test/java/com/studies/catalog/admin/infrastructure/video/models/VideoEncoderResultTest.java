...
class VideoEncoderResultTest {
    ...
    void testUnmarshallSuccessResult() throws IOException {
        ...
        final var json = """
                ...
                """.formatted(expectedId, expectedStatus, expectedOutputBucket,
                expectedEncoderVideoFolder, expectedResourceId, expectedFilePath);

        // when
        final var currentResult = this.json.parse(json);

        Assertions.assertThat(currentResult)
    ...
    void testMarshallSuccessResult() throws IOException {
        ...
        // when
        final var currentResult = this.json.write(aResult);
